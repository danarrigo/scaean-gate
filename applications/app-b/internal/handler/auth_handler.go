...
import (
	...
	"github.com/danarrigo/scaean-gate/applications/app-b/internal/dto"
...
func (h *AuthHandler) Callback(c *gin.Context) {
	...
	c.SetSameSite(http.SameSiteLaxMode)
	c.SetCookie("app_b_session", rawLocalToken, int(24*time.Hour.Seconds()), "/", "", h.Cfg.CookieSecure, true)
...
func (h *AuthHandler) Logout(c *gin.Context) {
	...
	c.SetCookie("app_b_session", "", -1, "/", "", h.Cfg.CookieSecure, true)
