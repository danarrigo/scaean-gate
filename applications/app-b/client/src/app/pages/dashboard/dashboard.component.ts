...
@Component({
    ...
    <div class="app-container">
      ...
      <header class="navbar">
        <div class="brand">
          ...
          <div>
            <h2>Bolt Workspace</h2>
            <span class="sub-brand">Relying Application B (Port 4202)</span>
          </div>
        </div>
      ...
      <main class="main-content">
        @if (loading) {
          <div class="loading-box">
            ...
            <p>Verifying session with Bolt backend...</p>
          </div>
          ...
          <div class="login-box">
            <div class="login-card">
              ...
              <p class="desc">You must sign in via the Central SSO Provider to access Bolt Workspace.</p>
  ...
  styles: [`
    ...
    .btn-primary { background: #d97706; color: white; border: none; border-radius: 8px; }
